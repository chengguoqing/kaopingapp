...
<view class="box cen dsf_ddrertxc bbm" >
		<navigator url="/pages/subjectOne/employee_statistical_analysis_fa" class="box_a df_fd_sdrert act" >
			<text class="pd fz32 z6">罚</text>
		</navigator>
		
		<navigator url="/pages/subjectOne/employee_statistical_analysis_jiang" class="box_a df_fd_sdrert" >
